...
export default function BoxesScreen() {
  const livros = [
    {
      id: 1,
      titulo: "Box Triologia O Senhor dos Anéis",
      autor: "H.G. Wells",
      preco: "R$ 53.92",
      imagem: require("../assets/images/boxSenhorDosAneis.png"),
    },
    {
      id: 2,
      ...
      autor: "Frank Herbert",
      preco: "R$ 60.90",
      imagem: require("../assets/images/boxDuna.png"),
    },
    {
      id: 3,
      titulo: "Box Triologia Jogos Vorazes",
      autor: "por Suzanne Collins",
      preco: "R$ 47.50",
      imagem: require("../assets/images/neuromancer.jpg"),
    },
    {
      id: 4,
      titulo: "Box Coleção Supernatural",
      autor: "por Camelot Editora",
      preco: "R$ 42.80",
      imagem: require("../assets/images/boxSupernatural.png"),
    },
  ];
  ...
  return (
    <Container>
      ...
      <FilterContainer horizontal showsHorizontalScrollIndicator={false}>
        ...
        <FilterButtonActive>
          <FilterTextActive>Boxes</FilterTextActive>
        </FilterButtonActive>
        <FilterButton>
          <FilterText>Ficção Científica</FilterText>
        </FilterButton>
      </FilterContainer>
